...
public class SOGBOFA extends Policy {

  public SOGBOFA() {
    super();
  }

  public SOGBOFA(String instance_name) {
    super(instance_name);
    Global.ifLift = true;
    searchDepth = -1;
...
//        r.fileAppend("BUIlding2", reward.toString() + "\n");
  ...
  public ArrayList<PVAR_INST_DEF> getActions(State s) throws EvalException {
    ...
    //add number of nodes * total updates to the total statistics
    ...
    System.out.println(highestScore); // 得分？
